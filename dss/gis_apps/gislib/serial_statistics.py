...
def graph_in_endcode64(DF,variable="",unit="",linear_regression = True):
...
class serial_statistics():
    ...
    def resample_data(self,timestep = "D"):
...
class calibration_validation():
    ...
    def statistical_parameters(self):
        ...
        nash = 1 - sum((ob_value-sm_value)*(ob_value-sm_value))/sum((ob_value-mean_ob)*(ob_value-mean_ob))
